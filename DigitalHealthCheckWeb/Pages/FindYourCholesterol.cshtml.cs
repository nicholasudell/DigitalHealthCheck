...
{
    public class FindYourCholesterolModel : HealthCheckPageModel
    {
        ...
        public FindYourCholesterolModel(Database database, ICredentialsDecrypter credentialsDecrypter, IPageFlow pageFlow) :
        ...
        public async Task<IActionResult> OnPostAsync(UnsanitisedModel model)
        {
            ...
            if (healthCheck is not null)
            {
                ...
                healthCheck.WentToFindCholesterol = true;
