...
{
    public class FollowUpCholesterolPageModel : FollowUpNumbersPageModel
    {
        ...
        public DefaultStatus? HeartRiskStatus { get; set; }

        public DefaultStatus? Status { get; set; }

        protected override string BeRemindedErrorMessage => "Select yes if you would like to be reminded to get your cholesterol checked";

        protected override string ConfidentToChangeErrorMessage => "Select how confident you are in making a plan to get your cholesterol checked.";

        protected override string CurrentRoute => "cholesterol";

        protected override string DoYouHavePlansErrorMessage => "Select yes if you have plans to get your cholesterol checked";

        protected override string ImportantToChangeErrorMessage => "Select how important it is for you to get your cholesterol checked.";

        protected override string SelectedOptionErrorMessage => "Select your preferred option to get your cholesterol checked.";

        protected override string SetADateErrorMessage => "Select yes if you will set a date to get your cholesterol checked";

        public FollowUpCholesterolPageModel(
            Database database,
        ...
        protected override async Task LoadPageData()
        {
            ...
            Status = result.Cholesterol;
            HeartRiskStatus = result.HeartDisease;
        }
        ...
        protected override async Task<FollowUp> GetFollowUpAsync(HealthCheck check)
        {
            ...
            return check.CholesterolFollowUp;
        }

        protected override void SetFollowUp(HealthCheck check, FollowUp followUp) => check.CholesterolFollowUp = followUp;
    }
}