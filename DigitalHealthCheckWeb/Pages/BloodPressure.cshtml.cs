...
namespace DigitalHealthCheckWeb.Pages
{
    ...
    public class BloodPressureModel : HealthCheckPageModel
    {
        ...
        public BloodPressureModel(Database database, ICredentialsDecrypter credentialsDecrypter, IPageFlow pageFlow) : base(database, credentialsDecrypter, pageFlow)
        {
        }
        ...
        public async Task<IActionResult> OnPostAsync(UnsanitisedModel model)
        {
            ...
            if (sanitisedModel.KnowYourBloodPressure == HaveYouBeenMeasured.Forgot)
            {
                return RedirectWithId("./FindYourBloodPressure");
            }
        ...
        async Task<SanitisedModel> ValidateAndSanitise(HealthCheck check, UnsanitisedModel model)
        {
            ...
            if (isValid && sanitisedModel.KnowYourBloodPressure == HaveYouBeenMeasured.Yes)
            {
