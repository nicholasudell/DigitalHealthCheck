...
namespace QMSUK.DigitalHealthCheck.Encryption
{
    ...
    public class AesEncrypter : IEncrypter, IDecrypter
    {
        static readonly Encoding TextEncoding = Encoding.Unicode;
        ...
        /// </exception>
        public AesEncrypter(string hexKey)
        {
        ...
        public AesEncrypter(byte[] key) => this.key = key ?? throw new ArgumentNullException(nameof(key));
