...
{
    /// <summary>
    /// Calculator that uses the QRISK3 algorithm to estimate the 10-year probability of a patient developing CVD.
    /// </summary>
    public class QRisk3
    {
        /// <summary>
        /// Calculates the minimum age a patient with no elevated risk factors would need to be to
        /// have a specific CVD risk or higher.
        /// </summary>
        /// <param name="gender">The patient's gender.</param>
        /// <param name="ethnicity">The patient's ethnicity.</param>
        /// <param name="cvdRisk">The CVD risk to calculate the age for.</param>
        /// <returns>
        /// The lowest age at which a patient with the provided gender and ethnicity would need to
        /// be to have the provided 10-year CVD risk, or null if no such age exists between 25 and 85.
        /// </returns>
        public static int? HeartAge(Gender gender, Ethnicity ethnicity, double cvdRisk)
        {
            for (var heartAge = 25; heartAge < 85; heartAge++)
            {
                if (ReferenceRisks.Reference(heartAge, gender, ethnicity) > cvdRisk)
                {
                    return heartAge;
                }
            }
        ...
        /// <summary>
        /// Calculates the 10-year CVD risk of a female patient.
        /// </summary>
        /// <param name="age">The patient's age.</param>
        /// <param name="b_AF">Whether the patient has atrial fibrillation.</param>
        /// <param name="b_atypicalantipsy">Whether the patient takes atypical antipsychotics.</param>
        /// <param name="b_corticosteroids">Whether the patient takes corticosteroids.</param>
        /// <param name="b_migraine">Whether the patient has migraines.</param>
        /// <param name="b_ra">Whether the patient has rheumatoid arthritis.</param>
        /// <param name="b_renal">Whether the patient has chronic kidney disease.</param>
        /// <param name="b_semi">Whether the patient has severe mental illness.</param>
        /// <param name="b_sle">Whether the patient has systemic lupus erythematosus.</param>
        /// <param name="b_treatedhyp">Whether the patient has been treated for hypertension.</param>
        /// <param name="b_type1">Whether the patient has type 1 diabetes.</param>
        /// <param name="b_type2">Whether the patient has type 2 diabetes.</param>
        /// <param name="bmi">The patient's bmi.</param>
        /// <param name="ethnicity">The patient's QRISK ethnicity.</param>
        /// <param name="fh_cvd">Whether the patient has a family history of CVD.</param>
        /// <param name="rati">The patient's cholesterol ratio.</param>
        /// <param name="sbp">The patient's systolic blood pressure.</param>
        /// <param name="sbps5">The standard deviation of at least two of the patient's most recent systolic blood pressure readings.</param>
        /// <param name="smoking">The patient's smoking status.</param>
        /// <param name="town">The patient's townsend deprecation score.</param>
        /// <returns>An estimated probability of the patient devloping CVD over the next 10 years. </returns>
        public double CalculateFemaleRisk
        (
            int age,
            int b_AF,
        ...
        /// <summary>
        /// Calculates the 10-year CVD risk of a male patient.
        /// </summary>
        /// <param name="age">The patient's age.</param>
        /// <param name="b_AF">Whether the patient has atrial fibrillation.</param>
        /// <param name="b_atypicalantipsy">Whether the patient takes atypical antipsychotics.</param>
        /// <param name="b_corticosteroids">Whether the patient takes corticosteroids.</param>
        /// <param name="b_impotence2">Whether the patient has impotence.</param>
        /// <param name="b_migraine">Whether the patient has migraines.</param>
        /// <param name="b_ra">Whether the patient has rheumatoid arthritis.</param>
        /// <param name="b_renal">Whether the patient has chronic kidney disease.</param>
        /// <param name="b_semi">Whether the patient has severe mental illness.</param>
        ...
        /// <param name="town">The patient's townsend deprecation score.</param>
        /// <returns>
        /// An estimated probability of the patient devloping CVD over the next 10 years.
        /// </returns>
        public double CalculateMaleRisk(
            int age,
            int b_AF,
            int b_atypicalantipsy,
            int b_corticosteroids,
        ...
        */
        ...
        /// <param name="b_type2">Whether the patient has type 2 diabetes.</param>
        /// <param name="bmi">The patient's bmi.</param>
        /// <param name="ethrisk">The patient's QRISK ethnicity group.</param>
        /// <param name="fh_cvd">Whether the patient has a family history of CVD.</param>
        /// <param name="rati">The patient's cholesterol ratio.</param>
        /// <param name="sbp">The patient's systolic blood pressure.</param>
        /// <param name="sbps5">The standard deviation of at least two of the patient's most recent systolic blood pressure readings.</param>
        /// <param name="smoke_cat">The patient's smoking status.</param>
        /// <param name="surv">Always 10.</param>
        /// <param name="town">The patient's townsend deprecation score.</param>
        /// <returns>An estimated probability of the patient devloping CVD over the next 10 years. </returns>
        private double qrisk_female_raw
        (
            int age,
            int b_AF,
            int b_atypicalantipsy,
